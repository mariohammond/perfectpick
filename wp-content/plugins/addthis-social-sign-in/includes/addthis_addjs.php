    ...
    */
    ...
    function getAtPluginPromoText(){
        ...
        if (apply_filters('addthis_crosspromote', '__return_true'))
        {
            ...
            $string = __(sprintf('<div class="updated">AddThis is no longer continuing development on the Social Sign-in Plugin. All existing features will continue to work, however, no further updates or fixes will be provided.</div>'));

            $string .= __(sprintf('<div>'));
